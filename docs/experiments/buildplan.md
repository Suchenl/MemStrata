...
accepted until a listed delivery gate is complete. This historical delivery
plan is retained for contributors; public users should start with
[`README.md`](../../README.md) and [`REPRODUCE.md`](../../REPRODUCE.md).
...
| July 22 | Main and ablation experiments finish | Each paper claim maps to a tracked driver, `results.json`, `results.md`, and a green or explicitly negative registry row |
...
PYTHONPATH=src python3 \
  scripts/vmem_bench/maintenance/report_gold_readiness.py \
...
The paper's contribution/baseline/table contract is maintained with the
manuscript; public users should follow [`REPRODUCE.md`](../../REPRODUCE.md)
for the executable frozen protocol.
...
registered in the relevant experiment registry.
