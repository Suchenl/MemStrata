...
| **Benchmark / Bench** | `vmem_bench` — the annotation pipeline that **evaluates this method** → frozen gold → deterministic scoring | VMem-Bench `src/vmem_bench/` | [`benchmark/`](https://github.com/Suchenl/VMem-Bench/tree/main/docs/benchmark/) |
| **Baseline / Control** | **Other systems** compared against the SUT on the **same benchmark** (causal / retrieval / diagnostic) | VMem-Bench `scripts/` | [`baselines/`](https://github.com/Suchenl/VMem-Bench/tree/main/docs/baselines/) |
...
| [VMem-Bench benchmark docs](https://github.com/Suchenl/VMem-Bench/tree/main/docs/benchmark/) | Authoritative documents for the **benchmark (`vmem_bench`)** protocol / contracts / annotation / scoring | Before editing VMem-Bench or scoring |
| [VMem-Bench baseline docs](https://github.com/Suchenl/VMem-Bench/tree/main/docs/baselines/) | Baseline strategies, Track A implementation, **fairness decisions** | Before running / editing / evaluating a baseline |
