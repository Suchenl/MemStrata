...
JUDGE_PROMPT = (
    ...
    "For a character: the same individual person, animal, or fictional character, using "
    "stable identifying features; a species/category mismatch is definitely different. "
    "For a prop/location: the same physical object/place.\n"
    "No entity name or requested description is provided: decide only from visual evidence "
    "in the query and references.\n"
